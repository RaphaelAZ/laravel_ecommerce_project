...
return [
    ...
    */
    ...
    'enum' => 'L\':attribute sélectionné est invalide.',
    ...
    |--------------------------------------------------------------------------
    |
    | Vous pouvez spécifier ici les messages de validation personnalisés pour les attributs en utilisant
    | la convention "attribut.rule" pour nommer les lignes. Cela permet de spécifier rapidement
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes de langue suivantes sont utilisées pour remplacer nos espaces réservés d'attribut
